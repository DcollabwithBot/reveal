...
export const GAME_MODES = [
  ...
  },
  {
    ...
    pixelIcon: '🌊',
    color: '#0ea5e9',
    description: 'Estimate cycle time in days instead of story points. Reveal flow blockers and team understanding gaps.',
    bestFor: 'Kanban teams, cycle time analysis, flow optimization',
    difficulty: 'BEGINNER',
    difficultyColor: 'var(--jade)',
    players: '2–12',
    duration: '20–60 min',
  ...
  },
  {
    ...
    pixelIcon: '🎲',
    color: '#ef4444',
    description: 'Two-card voting: probability × impact. Reveal a risk matrix with hot spots highlighted.',
    bestFor: 'All teams — risk assessment, project planning, sprint risk review',
    difficulty: 'INTERMEDIATE',
  ...
  },
  {
    ...
    pixelIcon: '⚔️',
    color: '#7c3aed',
    description: 'Write anonymous project assumptions. Vote on how dangerous each one is to have wrong. Slay the False Assumption boss.',
    bestFor: 'All teams — project kickoff, discovery, risk review',
    difficulty: 'INTERMEDIATE',
    difficultyColor: 'var(--amber)',
    players: '2–20',
    duration: '20–45 min',
