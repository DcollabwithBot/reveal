export default function Lobby({ user, onContinue, onGuest, onDashboard }) {
    ...
    <div style={styles.container}>
      ...
      <div style={styles.panel}>
        ...
        <div style={styles.actionStack}>
          ...
          <button style={styles.dashboardBtn} onClick={onDashboard}>🛡️ ÅBN DASHBOARD</button>
        </div>
...
const styles = {
  ...
  dashboardBtn: { width: '100%', padding: '12px 20px', background: '#101425', border: '2px solid #4f46e5', color: '#c7d2fe', fontFamily: "'Press Start 2P', monospace", fontSize: '8px', cursor: 'pointer', letterSpacing: '1px' },
